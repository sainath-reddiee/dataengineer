// src/components/TechCategories.jsx - FINAL VERSION with Mobile Optimization
...
// Card component with mobile optimization
const SparkleCard = ({ category }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Spark emitters in each corner - only on desktop */}
