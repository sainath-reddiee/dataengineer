...
export const generateGlossaryMeta = (term) => {
    ...
    const title = `What is ${term.term}? Definition & Guide`;
...
export const generateGlossaryHubMeta = () => {
    return {
        title: 'Data Engineering Glossary: 100+ Terms Explained',
...
export const generateComparisonMeta = (comparison) => {
    ...
    const title = `${comparison.toolA} vs ${comparison.toolB}: Key Differences & Winner (2026)`;
...
export const generateComparisonHubMeta = () => {
    return {
        title: 'Data Tool Comparisons: Airflow vs Prefect, Snowflake vs BigQuery',
