            ...
            {!loading && !error && (
              <>
                <div className="mb-6 text-sm text-gray-400">
                  Showing <span className="font-bold text-white">{filteredCertifications.length}</span> of <span className="font-bold text-white">{certifications?.length || 0}</span> resources.
                </div>
