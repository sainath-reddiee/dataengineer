      ...
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="bg-slate-800/50 rounded-2xl border border-slate-700 p-6">
          ...
          <div className="bg-slate-900 border border-slate-700 rounded-lg p-4 font-mono text-sm text-emerald-300 mb-3">
            builds_per_month â‰ˆ models × runs_per_day × 30 × 1.15
          </div>
          ...
          <p className="text-xs text-gray-500 mt-3">
            Example: a 120-model project run hourly → 120 × 24 × 30 × 1.15 â‰ˆ 99,360 builds/month — way over Team&apos;s 15,000 quota.
          </p>
        </div>
        ...
        <div className="bg-slate-800/50 rounded-2xl border border-slate-700 p-6">
          ...
          <div className="text-gray-300 text-sm leading-relaxed space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>Daily builds: 220 × 12 × 30 â‰ˆ 79,200</li>
              <li>+ tests (~1 per model): ~79,200 more</li>
              <li>+ CI runs: 50 × 220 × 2 â‰ˆ 22,000</li>
