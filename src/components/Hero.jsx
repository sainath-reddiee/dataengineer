// src/components/Hero.jsx - FINAL ENHANCED VERSION
import React, { useEffect } from 'react';
import { motion } from 'framer-motion';
import { Link } from 'react-router-dom';
// 1. ADD ChevronDown to the import
...
const Hero = () => {
  ...
  // 2. NEW animation variants for the chevrons
  ...
  return (
    // We'll keep the reduced height from our previous fix for better spacing
    <section ref={ref} className="relative flex items-center justify-center overflow-hidden py-20 px-6">
      {/* ... (Animated Background and Main Content remains the same) ... */}
      <div className="container mx-auto relative z-10">
        ...
        >
            {/* ... (Badge, H1, Paragraph, Buttons, Stats Grid) ... */}
            <motion.div
